# Novel Travel Route customized Website
...
Please check the complete web page deployment at: https://lin0he.github.io/Travel_webpage/ (not useful now due to API key lack, please download the file and try) , and due to the GitHub page limitation of video playing, there will be a delay when switching the pages.
